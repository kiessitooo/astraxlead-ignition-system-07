      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto mb-12">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gray-800/50 p-8 rounded-2xl border border-gray-700 hover:border-[#8F00FF]/50 transition-all duration-300 group hover:shadow-xl hover:shadow-[#8F00FF]/10"
            >
              <div className="mb-6">
